      ...
      <div className="inventory-no-print mb-4 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-[13px] leading-relaxed text-neutral-500">
            ...
            위탁 판매·예약완료·판매완료는 아이콘을 눌러 펼칩니다. 진천의 충주
            이동요청은 모든 관리자에게 같이 보입니다. 사업소별 원가·누적
            아이콘으로 정렬한 뒤 PDF로 저장할 수 있습니다.
          </p>
        </div>
        <InventoryPdfButton />
      </div>
      <div className="inventory-sheet-frame overflow-x-auto rounded-sm border border-[var(--line)] bg-white">
