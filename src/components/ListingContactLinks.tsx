...
export function ListingContactLinks({ whatsappHref, inquiryText }: Props) {
  ...
  const btnBase =
    "inline-flex h-7 flex-1 items-center justify-center gap-1 rounded px-2 text-[11.5px] font-medium tracking-wide transition hover:brightness-95 sm:h-8 sm:text-[12px]";
